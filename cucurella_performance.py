...
fig.add_trace(go.Scatterpolar(
    ...
    fill='toself',
    fillcolor='rgba(30, 144, 255, 0.3)',  # Tom azul royal (referência ao Chelsea)
...
fig.update_layout(
    title=dict(
        text="Análise de Desempenho Médio - Marc Cucurella",
...
if __name__ == '__main__':
    print("Gerando gráfico de desempenho do Marc Cucurella...")
    fig.show()