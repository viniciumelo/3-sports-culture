...
fig.add_trace(go.Scatterpolar(
    ...
    fill='toself',
    fillcolor='rgba(0, 191, 255, 0.3)',  # Tom azul-gelo ("Cold Palmer")
...
fig.update_layout(
    title=dict(
        text="Análise de Desempenho Médio - Cole Palmer",
    ...
    polar=dict(
        ...
        bgcolor='rgb(15, 20, 28)' # Fundo escuro estilo dashboard profissional
    ),
    paper_bgcolor='rgb(15, 20, 28)',
    showlegend=False,
    width=700,
    height=600
)
...
if __name__ == '__main__':
    print("Gerando gráfico de desempenho do Cole Palmer...")
    fig.show()